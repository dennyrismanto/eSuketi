                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 section-space--bottom--30 pl-30 pl-sm-15 pl-xs-15">
                        <div class="project-details">
                            ...
                            <p v-html="data.projectDetails.projectDetailsDesc"></p>
                        </div>
                    </div>

                    <div class="col-12">
                        <div class="row row-5 image-popup">
                            <div class="gallery-item single-gallery-thumb col-xl-3 col-lg-4 col-sm-6 col-12 section-space--top--10" v-for="gallery in data.projectDetailsGallery" :key="gallery.id">
